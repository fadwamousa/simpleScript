                    ...
                    <div class="rounded border jobs-wrap">
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="{{asset('external/images/company_logo_blank.png')}}" alt="Image" class="img-fluid mx-auto">
                            </div>
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center freelance">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="{{asset('external/images/logo_1.png')}}" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center partime">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="{{asset('external/images/logo_2.png')}}" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center" data-aos="fade">
                    ...
                    <p><a href="{{url('register')}}" class="btn btn-outline-warning py-3 px-4">
                            Job Seeker</a>
                        <a href="{{route('employer.register')}}"
                           class="btn btn-warning py-3 px-4">Job Employer</a></p>
