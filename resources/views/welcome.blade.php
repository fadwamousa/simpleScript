            ...
            <div class="row">
                <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="rounded border jobs-wrap">
                        ...
                        <a href="{{route('jobs.show',[$job->id,$job->slug])}}" class="job-item d-block d-md-flex align-items-center fulltime">
                            ...
                            <div class="job-category align-self-center">
                                ...
                                @elseif($job->type == 'parttime')
                                    <div class="p-3">
                                    <span class="text-primary p-2 rounded border border-info">
                                        {{$job->type}}
                                    </span>
                                    </div>
                                @else
                                    <div class="p-3">
                                    <span class="text-warning p-2 rounded border border-info">
                                        {{$job->type}}
                                    </span>
                                    </div>
                                    @endif
